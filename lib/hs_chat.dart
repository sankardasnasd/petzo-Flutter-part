...
class MyChatApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const HsMyChatPage(title: 'Flutter Demo Home Page'),
    );
  }
}

class HsMyChatPage extends StatefulWidget {
  const HsMyChatPage({super.key, required this.title});

  final String title;

  @override
  State<HsMyChatPage> createState() => _HsMyChatPageState();
}
...
class _HsMyChatPageState extends State<HsMyChatPage> {
  int _counter = 0;
  String name = "";
  ...
  Future<void> view_message() async {
    ...
    try {
      ...
      String url = '$urls/user_viewchat_to_hs';
                  ...
                  FloatingActionButton(
                    onPressed: () async {
                      ...
                      try {
                        ...
                        String url = ip + "/hs_chat_User_sendchat";
